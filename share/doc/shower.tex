...
\nwfilename{../../../src/shower/shower.nw}\nwbegincode{1}\moddef{\code{}shower{\char95}base.f90\edoc{}}\endmoddef
\LA{}File header\RA{}

module shower_base

\LA{}Use kinds\RA{} !NODEP!
  use constants !NODEP!
  use tao_random_numbers !NODEP!

\LA{}Standard module head\RA{}

\LA{}Shower base: public\RA{}

\LA{}Shower base: parameters\RA{}

\LA{}Shower base: interfaces\RA{}

contains

\LA{}Shower base: procedures\RA{}
...
\nwenddocs{}\nwbegincode{3}\moddef{Shower base: parameters}\endmoddef
...
\nwenddocs{}\nwbegincode{5}\moddef{Shower base: parameters}\plusendmoddef
  logical, parameter, public :: D_print = .false.
\eatline
\nwendcode{}\nwbegindocs{6}\nwdocspar
These parameters are the cut-off scale $t_{\text{cut}}$, given in
GeV$^2$ ({\tt{}PARJ(82)}), the cut-off scale for the $P_t^2$-ordered
shower in GeV$^2$, and the two shower parameters {\tt{}PARP(72)} and
{\tt{}PARP(61)}, respectively.
\nwenddocs{}\nwbegincode{7}\moddef{Shower base: parameters}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{8}\nwdocspar
The parameter {\tt{}MSTJ(45)} gives the maximum number of flavours in
gluon decay to quarks:
\nwenddocs{}\nwbegincode{9}\moddef{Shower base: parameters}\plusendmoddef
  integer, public :: D_Nf = 5
\nwendcode{}\nwbegindocs{10} %def D_Nf
\nwenddocs{}\nwbegindocs{11}\nwdocspar
...
and ISR ({\tt{}MSTJ(44)}, {\tt{}MSTP(64)}), respectively. The next is the
parameter {\tt{}PARU(111)}, which sets the value for constant $\alpha_s$,
and the flag whether to use $P_t$-ordered ISR.
\nwenddocs{}\nwbegincode{12}\moddef{Shower base: parameters}\plusendmoddef
...
shell, true corresponds to {\tt{}MSTP(63)} = 0.
\nwenddocs{}\nwbegincode{14}\moddef{Shower base: parameters}\plusendmoddef
  logical, public :: isr_only_onshell_emitted_partons = .true.
\eatline
\nwendcode{}\nwbegindocs{15}\nwdocspar
Flag whether ISR is angular ordered ({\tt{}MSTP(62)}).
\nwenddocs{}\nwbegincode{16}\moddef{Shower base: parameters}\plusendmoddef
  logical, public :: isr_angular_ordered = .true.
\eatline
\nwendcode{}\nwbegindocs{17}\nwdocspar
Treating either $u$ and $d$, or all quarks except $t$ as massless:
\nwenddocs{}\nwbegincode{18}\moddef{Shower base: parameters}\plusendmoddef
...
distribution, {\tt{}PARP(91)} and {\tt{}PARP(93)}, in GeV:
\nwenddocs{}\nwbegincode{20}\moddef{Shower base: parameters}\plusendmoddef
  real(default), public :: primordial_kt_width = 1.5_default
  real(default), public :: primordial_kt_cutoff = five
\eatline
\eatline
\nwendcode{}\nwbegindocs{21}\nwdocspar
The parameter {\tt{}PARP(66)}, the minimal energy of the emitted timelike
parton in the ISR ({\tt{}PARP(65)}), the factor for the first scale, as
...
\nwenddocs{}\nwbegincode{22}\moddef{Shower base: parameters}\plusendmoddef
...
\nwenddocs{}\nwbegincode{24}\moddef{Shower base: parameters}\plusendmoddef
...
\nwenddocs{}\nwbegincode{26}\moddef{Shower base: parameters}\plusendmoddef
  integer, public :: shower_pdf_set = 0
  integer, public :: shower_pdf_type = STRF_NONE
\eatline
\nwendcode{}\nwbegindocs{27}\nwdocspar
\nwenddocs{}\nwbegincode{28}\moddef{Shower base: public}\endmoddef
  public :: D_alpha_s_isr
  public :: D_alpha_s_fsr
\nwendcode{}\nwbegincode{29}\moddef{Shower base: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{30}Mass and mass squared selection functions. All masses are in
...
\nwenddocs{}\nwbegincode{31}\moddef{Shower base: public}\plusendmoddef
  public :: mass_type
  public :: mass_squared_type
\nwendcode{}\nwbegincode{32}\moddef{Shower base: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{33}The number of flavours allowed in an actual $g \to qq$ splitting.
\nwenddocs{}\nwbegincode{34}\moddef{Shower base: public}\plusendmoddef
  public :: number_of_flavors
\nwendcode{}\nwbegincode{35}\moddef{Shower base: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{36}Splitting functions. They are also defined in {\tt{}sm{\char95}physics}. This
should be unified at some point.
\nwenddocs{}\nwbegincode{37}\moddef{Shower base: public}\plusendmoddef
  public :: P_qqg
  public :: P_gqq
  public :: P_ggg
\nwendcode{}\nwbegincode{38}\moddef{Shower base: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{39}Analytically integrated splitting kernels.
\nwenddocs{}\nwbegincode{40}\moddef{Shower base: public}\plusendmoddef
  public :: integral_over_P_gqq
  public :: integral_over_P_ggg
  public :: integral_over_P_qqg
\nwendcode{}\nwbegincode{41}\moddef{Shower base: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{42}Methods to set parameters, once there should be a better interface.
\nwenddocs{}\nwbegincode{43}\moddef{Shower base: public}\plusendmoddef
...
\nwendcode{}\nwbegincode{44}\moddef{Shower base: procedures}\plusendmoddef
...
\nwenddocs{}\nwbegincode{46}\moddef{\code{}shower{\char95}partons.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}Shower partons: public\RA{}

\LA{}Shower partons: types\RA{}

contains

\LA{}Shower partons: procedures\RA{}
...
The type {\tt{}parton{\char95}t} defines a parton for the shower. The {\tt{}x} value
of the parton is only needed for spacelike showers. The pointer
{\tt{}initial} is only needed for partons in initial showers, it points to
the hadron the parton is coming from. An auxiliary value for the
$P_t$-ordered ISR is {\tt{}aux{\char95}pt}. Then, there are two auxiliary entries
for the clustering of CKKW pseudo weights and CKKW matching,
{\tt{}ckkwlabel} and {\tt{}ckkwscale}.
\nwenddocs{}\nwbegincode{48}\moddef{Shower partons: public}\endmoddef
  public :: parton_t
\nwendcode{}\nwbegincode{49}\moddef{Shower partons: types}\endmoddef
  type :: parton_t
     integer :: nr = 0
     integer :: type = 0
...
\eatline
\nwendcode{}\nwbegindocs{50}\nwdocspar
\nwenddocs{}\nwbegincode{51}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_pointer_t
\nwendcode{}\nwbegincode{52}\moddef{Shower partons: types}\plusendmoddef
...
\nwendcode{}\nwbegindocs{53}\nwdocspar
\subsection{Routines}
\nwenddocs{}\nwbegincode{54}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_copy
\nwendcode{}\nwbegincode{55}\moddef{Shower partons: procedures}\endmoddef
...
\nwendcode{}\nwbegindocs{56} %def parton_copy
\nwenddocs{}\nwbegindocs{57}This returns the angle between the daughters assuming them to be
massless.
\nwenddocs{}\nwbegincode{58}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_costheta
\nwendcode{}\nwbegincode{59}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{60}The same for massive daughters.
\nwenddocs{}\nwbegincode{61}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_costheta_correct
\nwendcode{}\nwbegindocs{62}\nwdocspar
\nwenddocs{}\nwbegincode{63}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{64}This function returns the angle between the momentum vectors of the
parton and first daughter.
\nwenddocs{}\nwbegincode{65}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_costheta_motherfirst
\nwendcode{}\nwbegincode{66}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{67}Get the parton velocities.
\nwenddocs{}\nwbegincode{68}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_beta
\nwendcode{}\nwbegindocs{69}\nwdocspar
\nwenddocs{}\nwbegincode{70}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{71}Write routine.
\nwenddocs{}\nwbegincode{72}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_write
\nwendcode{}\nwbegincode{73}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{74}\nwdocspar
\nwenddocs{}\nwbegincode{75}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_final
\nwendcode{}\nwbegincode{76}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{77}\nwdocspar
\nwenddocs{}\nwbegincode{78}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_branched
\nwendcode{}\nwbegincode{79}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{80}\nwdocspar
\nwenddocs{}\nwbegincode{81}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_simulated
\nwendcode{}\nwbegincode{82}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{83}\nwdocspar
\nwenddocs{}\nwbegincode{84}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_simulated
\nwendcode{}\nwbegincode{85}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{86}\nwdocspar
\nwenddocs{}\nwbegincode{87}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_momentum
\nwendcode{}\nwbegincode{88}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{89}\nwdocspar
\nwenddocs{}\nwbegincode{90}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_momentum
\nwendcode{}\nwbegincode{91}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{92}\nwdocspar
\nwenddocs{}\nwbegincode{93}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_energy
\nwendcode{}\nwbegincode{94}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{95}\nwdocspar
\nwenddocs{}\nwbegincode{96}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_energy
\nwendcode{}\nwbegincode{97}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{98}\nwdocspar
\nwenddocs{}\nwbegincode{99}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_parent
\nwendcode{}\nwbegincode{100}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{101}\nwdocspar
\nwenddocs{}\nwbegincode{102}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_parent
\nwendcode{}\nwbegincode{103}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{104}\nwdocspar
\nwenddocs{}\nwbegincode{105}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_initial
\nwendcode{}\nwbegincode{106}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{107}\nwdocspar
\nwenddocs{}\nwbegincode{108}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_initial
\nwendcode{}\nwbegincode{109}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{110}\nwdocspar
\nwenddocs{}\nwbegincode{111}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_set_child
\nwendcode{}\nwbegincode{112}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{113}\nwdocspar
\nwenddocs{}\nwbegincode{114}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_get_child
\nwendcode{}\nwbegincode{115}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{116}\nwdocspar
\nwenddocs{}\nwbegincode{117}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_quark
\nwendcode{}\nwbegindocs{118}\nwdocspar
\nwenddocs{}\nwbegincode{119}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{120}\nwdocspar
\nwenddocs{}\nwbegincode{121}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_squark
\nwendcode{}\nwbegincode{122}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{123}\nwdocspar
\nwenddocs{}\nwbegincode{124}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_gluon
\nwendcode{}\nwbegincode{125}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegincode{126}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_gluino
\nwendcode{}\nwbegincode{127}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{128}Only the proton is implemented yet.
\nwenddocs{}\nwbegincode{129}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_hadron
\nwendcode{}\nwbegincode{130}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{131}TODO: SUSY partons.
\nwenddocs{}\nwbegincode{132}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_is_colored
\nwendcode{}\nwbegincode{133}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{134}\nwdocspar
\nwenddocs{}\nwbegincode{135}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_p4square
\nwendcode{}\nwbegincode{136}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{137}\nwdocspar
\nwenddocs{}\nwbegincode{138}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_p3square
\nwendcode{}\nwbegincode{139}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{140}\nwdocspar
\nwenddocs{}\nwbegincode{141}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_p3abs
\nwendcode{}\nwbegincode{142}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{143}\nwdocspar
\nwenddocs{}\nwbegincode{144}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_mass
\nwendcode{}\nwbegincode{145}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{146}\nwdocspar
\nwenddocs{}\nwbegincode{147}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_mass_squared
\nwendcode{}\nwbegincode{148}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{149}\nwdocspar
\nwenddocs{}\nwbegincode{150}\moddef{Shower partons: public}\plusendmoddef
  public :: P_prt_to_child1
\nwendcode{}\nwbegincode{151}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{152}This function returns whether the kinematics of the branching of
parton {\tt{}prt} into its daughters are allowed or not.
\nwenddocs{}\nwbegincode{153}\moddef{Shower partons: public}\plusendmoddef
  public :: thetabar
\nwendcode{}\nwbegincode{154}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{155}\nwdocspar
\nwenddocs{}\nwbegincode{156}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_apply_z
\nwendcode{}\nwbegincode{157}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{158}\nwdocspar
\nwenddocs{}\nwbegincode{159}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_apply_costheta
\nwendcode{}\nwbegincode{160}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{161}\nwdocspar
\nwenddocs{}\nwbegincode{162}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_apply_lorentztrafo
\nwendcode{}\nwbegincode{163}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{164}\nwdocspar
\nwenddocs{}\nwbegincode{165}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_apply_lorentztrafo_recursive
\nwendcode{}\nwbegincode{166}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{167}This takes the three-momentum of a parton and generates
three-momenta of its children.
\nwenddocs{}\nwbegincode{168}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_generate_ps
\nwendcode{}\nwbegincode{169}\moddef{Shower partons: procedures}\plusendmoddef
  subroutine parton_generate_ps (prt)
    ...
    if (prt%type == 94) then
       ...
       \LA{}Enforce right-handed system for \code{}directions\edoc{}\RA{}
...
\eatline
\nwendcode{}\nwbegindocs{170}\nwdocspar
\nwenddocs{}\nwbegincode{171}\moddef{Enforce right-handed system for \code{}directions\edoc{}}\endmoddef
...
\nwendcode{}\nwbegindocs{172}\nwdocspar
This routine is similar to {\tt{}parton{\char95}generate{\char95}ps}, but now for the
ISR. It takes the three-momentum of a parton's first child as fixed and
generates the two remaining three-momenta.
\nwenddocs{}\nwbegincode{173}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_generate_ps_ini
\nwendcode{}\nwbegincode{174}\moddef{Shower partons: procedures}\plusendmoddef
...
\nwenddocs{}\nwbegincode{176}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_next_t_ana
\nwendcode{}\nwbegincode{177}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{178}\nwdocspar
\nwenddocs{}\nwbegincode{179}\moddef{Shower partons: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{180}Simulation routine. The variable {\tt{}lookatsister} takes constraints
from the sister parton into account, if not given it is assumed
{\tt{}.true.}. {\tt{}a} and {\tt{}x} are three-dimensional arrays for values
used for the integration.
\nwenddocs{}\nwbegincode{181}\moddef{Shower partons: public}\plusendmoddef
  public :: parton_simulate_stept
\nwendcode{}\nwbegincode{182}\moddef{Shower partons: procedures}\plusendmoddef
  subroutine parton_simulate_stept &
    ...
    \LA{}Set \code{}sister\edoc{} if \code{}lookatsister\edoc{} is true or not given\RA{}
...
\eatline
\nwendcode{}\nwbegindocs{183}\nwdocspar
\nwenddocs{}\nwbegincode{184}\moddef{Set \code{}sister\edoc{} if \code{}lookatsister\edoc{} is true or not given}\endmoddef
sister => null()
SET_SISTER: do
...
\nwendcode{}\nwbegindocs{185}\nwdocspar
\nwenddocs{}\nwbegindocs{186}From the whole ISR algorithm all functionality has been moved to
{\tt{}shower{\char95}core.f90}. Only {\tt{}maxzz} remains here, because more than
one module needs to access it.
\nwenddocs{}\nwbegincode{187}\moddef{Shower partons: public}\plusendmoddef
  public :: maxzz
\nwendcode{}\nwbegincode{188}\moddef{Shower partons: procedures}\plusendmoddef
...
\nwenddocs{}\nwbegincode{190}\moddef{\code{}shower{\char95}core.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}Shower core: public\RA{}

\LA{}Shower core: parameters\RA{}

\LA{}Shower core: types\RA{}

\LA{}Shower core: interfaces\RA{}

contains

\LA{}Shower core: procedures\RA{}

end module shower_core
\eatline
\nwendcode{}\nwbegindocs{191}\nwdocspar
\nwenddocs{}\nwbegincode{192}\moddef{Shower core: interfaces}\endmoddef
  interface
...
\eatline
\nwendcode{}\nwbegindocs{193}\nwdocspar
\nwenddocs{}\nwbegincode{194}\moddef{Shower core: public}\endmoddef
  public :: shower_interaction_t
\nwendcode{}\nwbegincode{195}\moddef{Shower core: types}\endmoddef
...
\eatline
\eatline
\nwendcode{}\nwbegindocs{196}The main type of {\tt{}shower{\char95}core}:
\nwenddocs{}\nwbegincode{197}\moddef{Shower core: public}\plusendmoddef
  public :: shower_t
\nwendcode{}\nwbegincode{198}\moddef{Shower core: types}\plusendmoddef
  type :: shower_t
     ...
     logical :: valid
   contains
   \LA{}Shower core: shower: TBP\RA{}
  end type shower_t

\eatline
\nwendcode{}\nwbegindocs{199}The parameters of the shower module:
\nwenddocs{}\nwbegincode{200}\moddef{Shower core: parameters}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{201}\nwdocspar
\nwenddocs{}\nwbegincode{202}\moddef{Shower core: shower: TBP}\endmoddef
  procedure :: add_interaction_2ton => shower_add_interaction_2ton
\nwendcode{}\nwbegincode{203}\moddef{Shower core: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{204}In this routine, {\tt{}y} and {\tt{}ymin} are the jet measures, {\tt{}w} and
{\tt{}wmax} are weights, {\tt{}s} is the kinematic energy squared of the
interaction. The flag {\tt{}isr{\char95}is{\char95}possible} checks whether the initial
...
treated massless.
\nwenddocs{}\nwbegincode{205}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: add_interaction_2ton_CKKW => shower_add_interaction_2ton_CKKW
\nwendcode{}\nwbegincode{206}\moddef{Shower core: procedures}\plusendmoddef
  subroutine shower_add_interaction_2ton_CKKW &
    ...
    \LA{}Add a new interaction to \code{}shower{\char37}interactions\edoc{}\RA{}
    ...
    \LA{}Add partons from \code{}shower{\char37}interactions\edoc{} to \code{}shower{\char37}partons\edoc{}\RA{}
    ...
    if (allocated (ckkw_pseudo_weights%weights)) then
       \LA{}Perform clustering using the CKKW weights\RA{}
    else
       \LA{}Perform clustering in the usual way\RA{}
    end if

    !!! add all partons to the shower
    \LA{}Count number of associated \code{}shower{\char37}partons(i){\char37}p\edoc{}\RA{}
  ...
  contains
    ...
    \LA{}Procedures of \code{}shower{\char95}add{\char95}interaction{\char95}2ton{\char95}CKKW\edoc{}\RA{}
  end subroutine shower_add_interaction_2ton_CKKW

\eatline
\nwendcode{}\nwbegindocs{207}\nwdocspar
\nwenddocs{}\nwbegincode{208}\moddef{Add a new interaction to \code{}shower{\char37}interactions\edoc{}}\endmoddef
...
deallocate (temp)
\nwendcode{}\nwbegindocs{209}\nwdocspar
\nwenddocs{}\nwbegincode{210}\moddef{Add partons from \code{}shower{\char37}interactions\edoc{} to \code{}shower{\char37}partons\edoc{}}\endmoddef
...
!!! call shower%write ()
\nwendcode{}\nwbegindocs{211}\nwdocspar
\nwenddocs{}\nwbegincode{212}\moddef{Perform clustering using the CKKW weights}\endmoddef
CKKW_CLUSTERING: do
...
\nwendcode{}\nwbegindocs{213}\nwdocspar
\nwenddocs{}\nwbegincode{214}\moddef{Perform clustering in the usual way}\endmoddef
CLUSTERING: do
...
\nwendcode{}\nwbegindocs{215}\nwdocspar
\nwenddocs{}\nwbegincode{216}\moddef{Count number of associated \code{}shower{\char37}partons(i){\char37}p\edoc{}}\endmoddef
n_partons_shower = 0
if (allocated (shower%partons)) then
   do i = 1, size (shower%partons)
...
\nwendcode{}\nwbegindocs{217}\nwdocspar
\nwenddocs{}\nwbegincode{218}\moddef{Procedures of \code{}shower{\char95}add{\char95}interaction{\char95}2ton{\char95}CKKW\edoc{} (not used)}\endmoddef
...
\nwendcode{}\nwbegindocs{219}\nwdocspar
\nwenddocs{}\nwbegincode{220}\moddef{Procedures of \code{}shower{\char95}add{\char95}interaction{\char95}2ton{\char95}CKKW\edoc{}}\endmoddef
...
\nwendcode{}\nwbegindocs{221}\nwdocspar
\nwenddocs{}\nwbegincode{222}\moddef{Procedures of \code{}shower{\char95}add{\char95}interaction{\char95}2ton{\char95}CKKW\edoc{}}\plusendmoddef
...
\nwendcode{}\nwbegindocs{223}\nwdocspar
\nwenddocs{}\nwbegincode{224}\moddef{Procedures of \code{}shower{\char95}add{\char95}interaction{\char95}2ton{\char95}CKKW\edoc{}}\plusendmoddef
...
\nwendcode{}\nwbegindocs{225}\nwdocspar
\nwenddocs{}\nwbegincode{226}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: simulate_no_isr_shower => shower_simulate_no_isr_shower
\nwendcode{}\nwbegincode{227}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{228}\nwdocspar
\nwenddocs{}\nwbegincode{229}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: simulate_no_fsr_shower => shower_simulate_no_fsr_shower
\nwendcode{}\nwbegincode{230}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{231}\nwdocspar
\nwenddocs{}\nwbegincode{232}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{233}This removes emitted timelike partons.
\nwenddocs{}\nwbegincode{234}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{235}This removes the parton {\tt{}prt} and all its children.
\nwenddocs{}\nwbegincode{236}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{237}\nwdocspar
\nwenddocs{}\nwbegincode{238}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: sort_partons => shower_sort_partons
\nwendcode{}\nwbegincode{239}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{240}Creation and finalization.
\nwenddocs{}\nwbegincode{241}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: create => shower_create
\nwendcode{}\nwbegincode{242}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{243}Deallocate the interaction pointers.
\nwenddocs{}\nwbegincode{244}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: final => shower_final
\nwendcode{}\nwbegincode{245}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{246}Bookkeeping functions.
\nwenddocs{}\nwbegincode{247}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_next_free_nr => shower_get_next_free_nr
\nwendcode{}\nwbegincode{248}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{249}\nwdocspar
\nwenddocs{}\nwbegincode{250}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: set_next_color_nr => shower_set_next_color_nr
\nwendcode{}\nwbegincode{251}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{252}\nwdocspar
\nwenddocs{}\nwbegincode{253}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_next_color_nr => shower_get_next_color_nr
\nwendcode{}\nwbegincode{254}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{255}\nwdocspar
\nwenddocs{}\nwbegincode{256}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{257}\nwdocspar
\nwenddocs{}\nwbegincode{258}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: add_child => shower_add_child
\nwendcode{}\nwbegincode{259}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{260}\nwdocspar
\nwenddocs{}\nwbegincode{261}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: add_parent => shower_add_parent
\nwendcode{}\nwbegincode{262}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{263}\nwdocspar
\nwenddocs{}\nwbegincode{264}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{265}\nwdocspar
\nwenddocs{}\nwbegincode{266}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{267}\nwdocspar
\nwenddocs{}\nwbegincode{268}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{269}\nwdocspar
\nwenddocs{}\nwbegincode{270}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_final_colored_ME_partons => &
       shower_get_final_colored_ME_partons
\nwendcode{}\nwbegincode{271}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{272}\nwdocspar
\nwenddocs{}\nwbegincode{273}\moddef{Shower core: public}\plusendmoddef
  public :: shower_get_final_partons
\nwendcode{}\nwbegincode{274}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{275}\nwdocspar
\nwenddocs{}\nwbegincode{276}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{277}\nwdocspar
\nwenddocs{}\nwbegincode{278}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{279}\nwdocspar
\nwenddocs{}\nwbegincode{280}\moddef{Shower core: public}\plusendmoddef
  public :: shower_interaction_get_shat
\nwendcode{}\nwbegincode{281}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{282}\nwdocspar
\nwenddocs{}\nwbegincode{283}\moddef{Shower core: public}\plusendmoddef
  public :: shower_interaction_get_s
\nwendcode{}\nwbegincode{284}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{285}\nwdocspar
\nwenddocs{}\nwbegincode{286}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{287}\nwdocspar
\nwenddocs{}\nwbegincode{288}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{289}\nwdocspar
\nwenddocs{}\nwbegincode{290}\moddef{Shower core: procedures (not used)}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{291}\nwdocspar
\nwenddocs{}\nwbegincode{292}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{293}\nwdocspar
\nwenddocs{}\nwbegincode{294}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: update_beamremnants => shower_update_beamremnants
\nwendcode{}\nwbegincode{295}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{296}\nwdocspar
\nwenddocs{}\nwbegincode{297}\moddef{Shower core: procedures}\plusendmoddef
...
\nwendcode{}\nwbegindocs{298} %def interaction_apply_lorentztrafo
\nwenddocs{}\nwbegindocs{299}\nwdocspar
\nwenddocs{}\nwbegincode{300}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{301}This boosts partons belonging to the interaction to the
center-of-mass frame of its partons nearest to the hadron.
\nwenddocs{}\nwbegincode{302}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{303}This boosts every interaction to the center-of-mass-frame of its
partons nearest to the hadron.
\nwenddocs{}\nwbegincode{304}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{305}This boost all partons so that initial partons have their assigned
$x$-value.
\nwenddocs{}\nwbegincode{306}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: boost_to_labframe => shower_boost_to_labframe
\nwendcode{}\nwbegincode{307}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{308}This boosts all partons so that initial partons have their
assigned $x$-value.
\nwenddocs{}\nwbegincode{309}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{310}Only rotate to z if inital hadrons are given (and they are assumed
to be aligned along the z-axis).
\nwenddocs{}\nwbegincode{311}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{312}Rotate initial partons to lie along $\pm z$ axis.
\nwenddocs{}\nwbegincode{313}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{314}\nwdocspar
\nwenddocs{}\nwbegincode{315}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{316}\nwdocspar
\nwenddocs{}\nwbegincode{317}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: generate_primordial_kt => shower_generate_primordial_kt
\nwendcode{}\nwbegincode{318}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{319}Output.
\nwenddocs{}\nwbegincode{320}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{321}\nwdocspar
\nwenddocs{}\nwbegincode{322}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: write => shower_write
\nwendcode{}\nwbegincode{323}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{324}\nwdocspar
\nwenddocs{}\nwbegincode{325}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: write_lhef => shower_write_lhef
\nwendcode{}\nwbegincode{326}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{327}\nwdocspar
\nwenddocs{}\nwbegincode{328}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{329}\nwdocspar
\nwenddocs{}\nwbegincode{330}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{331}\nwdocspar
\nwenddocs{}\nwbegincode{332}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{333}\nwdocspar
\nwenddocs{}\nwbegincode{334}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{335}\nwdocspar
\nwenddocs{}\nwbegincode{336}\moddef{Shower core: procedures (not used)}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{337}\nwdocspar
\nwenddocs{}\nwbegincode{338}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{339}\nwdocspar
\nwenddocs{}\nwbegincode{340}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{341}\nwdocspar
\nwenddocs{}\nwbegincode{342}\moddef{Shower core: procedures}\plusendmoddef
  subroutine shower_simulate_children_ana (shower,prt)
    ...
    \LA{}Set beam-remnants and internal partons as simulated\RA{}
    ...
    do
       ...
       if (parton_is_simulated (prt%child1) .and. &
          ...
          if (sqrt (prt%t) <= sqrt (prt%child1%t) + sqrt (prt%child2%t)) then
            \LA{}Repeat the simulation for the parton with the lower virtuality\RA{}
          else
             exit
          end if
       end if
...
\eatline
\nwendcode{}\nwbegindocs{343}\nwdocspar
\nwenddocs{}\nwbegincode{344}\moddef{Set beam-remnants and internal partons as simulated}\endmoddef
...
\nwendcode{}\nwbegindocs{345}\nwdocspar
\nwenddocs{}\nwbegincode{346}\moddef{Repeat the simulation for the parton with the lower virtuality}\endmoddef
...
\nwendcode{}\nwbegindocs{347}\nwdocspar
\nwenddocs{}\nwbegincode{348}\moddef{Add children}\endmoddef
do daughter = 1, 2
   if (signal_is_pending ()) return
   if (daughter == 1) then
...
\nwendcode{}\nwbegindocs{349}\nwdocspar
\nwenddocs{}\nwbegincode{350}\moddef{Shower core: procedures (not used)}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{351}The recoiler is {\tt{}otherprt}. Instead of the random number and the
exponential of the integral, we compare the logarithm of the random
number and the integral.
\nwenddocs{}\nwbegincode{352}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{353}This function returns a pointer to the parton with the next ISR
branching, while FSR branchings are ignored.
\nwenddocs{}\nwbegincode{354}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: generate_next_isr_branching_veto => &
       shower_generate_next_isr_branching_veto
\nwendcode{}\nwbegincode{355}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{356}\nwdocspar
\nwenddocs{}\nwbegincode{357}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{358}\nwdocspar
\nwenddocs{}\nwbegincode{359}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{360}This returns a pointer to the parton with the next ISR branching, again
FSR branchings are ignored.
\nwenddocs{}\nwbegincode{361}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: generate_next_isr_branching => &
       shower_generate_next_isr_branching
\nwendcode{}\nwbegincode{362}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{363}This is a loop which searches for all emitted and branched partons.
\nwenddocs{}\nwbegincode{364}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: generate_fsr_for_isr_partons => &
       shower_generate_fsr_for_partons_emitted_in_ISR
\nwendcode{}\nwbegincode{365}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{366}This executes the branching generated by
{\tt{}shower{\char95}generate{\char95}next{\char95}isr{\char95}branching}, that means it generates the
flavours, momenta, etc.
\nwenddocs{}\nwbegincode{367}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: execute_next_isr_branching => shower_execute_next_isr_branching
\nwendcode{}\nwbegincode{368}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{369}\nwdocspar
\nwenddocs{}\nwbegincode{370}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{371}\nwdocspar
\nwenddocs{}\nwbegincode{372}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_ISR_scale => shower_get_ISR_scale
\nwendcode{}\nwbegincode{373}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{374}\nwdocspar
\nwenddocs{}\nwbegincode{375}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: set_max_isr_scale => shower_set_max_isr_scale
\nwendcode{}\nwbegincode{376}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{377}\nwdocspar
\nwenddocs{}\nwbegincode{378}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: interaction_generate_fsr_2ton => &
       shower_interaction_generate_fsr_2ton
\nwendcode{}\nwbegindocs{379}\nwdocspar
\nwenddocs{}\nwbegincode{380}\moddef{Shower core: procedures}\plusendmoddef
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!! new version
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
\eatline
\nwendcode{}\nwbegindocs{381} Perform the FSR for one parton, it is assumed, that the parton
...
\nwenddocs{}\nwbegincode{382}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{383}\nwdocspar
\nwenddocs{}\nwbegincode{384}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{385}\nwdocspar
\nwenddocs{}\nwbegincode{386}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{387}The next two routines are for PDFs. Wrapper function to return
parton densities. 
\nwenddocs{}\nwbegincode{388}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_pdf => shower_get_pdf
\nwendcode{}\nwbegincode{389}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{390}Wrapper function to return momentum densities. 
\nwenddocs{}\nwbegincode{391}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: get_xpdf => shower_get_xpdf
\nwendcode{}\nwbegincode{392}\moddef{Shower core: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{393}\nwdocspar
\nwenddocs{}\nwbegincode{394}\moddef{Shower core: shower: TBP}\plusendmoddef
  procedure :: pdf_func => shower_pdf_func
\nwendcode{}\nwbegincode{395}\moddef{Shower core: procedures}\plusendmoddef
...
\nwenddocs{}\nwbegincode{397}\moddef{\code{}shower{\char95}topythia.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}Shower2pythia: public\RA{}

contains

\LA{}Shower2pythia: procedures\RA{}

  end module shower_topythia

\eatline
\nwendcode{}\nwbegindocs{398}\nwdocspar
\nwenddocs{}\nwbegincode{399}\moddef{Shower2pythia: public}\endmoddef
  public :: shower_converttopythia
\nwendcode{}\nwbegindocs{400}\nwdocspar
\nwenddocs{}\nwbegincode{401}\moddef{Shower2pythia: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{402}\nwdocspar
\nwenddocs{}\nwbegincode{403}\moddef{Shower2pythia: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{404}\nwdocspar
\nwenddocs{}\nwbegincode{405}\moddef{Shower2pythia: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{406}\nwdocspar
\nwenddocs{}\nwbegincode{407}\moddef{Shower2pythia: procedures}\plusendmoddef
...
\nwendcode{}\nwbegindocs{408}\nwdocspar
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\nwenddocs{}\nwbegincode{409}\moddef{\code{}pythia{\char95}up.f\edoc{}}\endmoddef
C*********************************************************************
C*********************************************************************
C*                                                                  **
C*                                                       Mar 2011   **
...
\nwenddocs{}\nwbegincode{411}\moddef{\code{}mlm{\char95}matching.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}MLM matching: public\RA{}

\LA{}MLM matching: types\RA{}

contains

\LA{}MLM matching: procedures\RA{}

end module mlm_matching
\eatline
\nwendcode{}\nwbegindocs{412}This is a container for the (colored) parton momenta as well as the
jet momenta.
\nwenddocs{}\nwbegincode{413}\moddef{MLM matching: public}\endmoddef
  public :: mlm_matching_data_t
\nwendcode{}\nwbegincode{414}\moddef{MLM matching: types}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{415}\nwdocspar
\nwenddocs{}\nwbegincode{416}\moddef{MLM matching: public}\plusendmoddef
  public :: mlm_matching_settings_t
\nwendcode{}\nwbegincode{417}\moddef{MLM matching: types}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{418}\nwdocspar
\nwenddocs{}\nwbegincode{419}\moddef{MLM matching: public}\plusendmoddef
  public :: mlm_matching_settings_write
\nwendcode{}\nwbegincode{420}\moddef{MLM matching: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{421}\nwdocspar
\nwenddocs{}\nwbegincode{422}\moddef{MLM matching: public}\plusendmoddef
  public :: mlm_matching_data_write
\nwendcode{}\nwbegincode{423}\moddef{MLM matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{424}\nwdocspar
\nwenddocs{}\nwbegincode{425}\moddef{MLM matching: public}\plusendmoddef
  public :: mlm_matching_data_final
\nwendcode{}\nwbegincode{426}\moddef{MLM matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{427}\nwdocspar
\nwenddocs{}\nwbegincode{428}\moddef{MLM matching: public}\plusendmoddef
  public :: mlm_matching_apply
\nwendcode{}\nwbegincode{429}\moddef{MLM matching: procedures}\plusendmoddef
...
!!! It is the denominator of the KT measure. Candidate for removal
    ...
    \LA{}Set \code{}n{\char95}jets{\char95}ME/PS\edoc{} from \code{}data\edoc{} (or equal zero)\RA{}

    \LA{}Jet clustering for partons after matrix element\RA{}

    \LA{}Jet clustering for partons after shower\RA{}

    ! call data_write(data)

    \LA{}Veto: too many or not enough jets after PS\RA{}

    \LA{}Cluster ME jets with PS jets one at a time\RA{}
...
\eatline
\nwendcode{}\nwbegindocs{430}\nwdocspar
\nwenddocs{}\nwbegincode{431}\moddef{Set \code{}n{\char95}jets{\char95}ME/PS\edoc{} from \code{}data\edoc{} (or equal zero)}\endmoddef
if (allocated (data%P_ME)) then
...
\nwendcode{}\nwbegindocs{432}\nwdocspar
\nwenddocs{}\nwbegincode{433}\moddef{Jet clustering for partons after matrix element}\endmoddef
if (n_jets_ME > 0) then
   ...
   \LA{}Set \code{}imode\edoc{} for lepton or hadron collisions\RA{}
...
\nwendcode{}\nwbegindocs{434}\nwdocspar
\nwenddocs{}\nwbegincode{435}\moddef{Jet clustering for partons after shower}\endmoddef
if (n_jets_PS > 0) then
...
\nwendcode{}\nwbegindocs{436}\nwdocspar
\nwenddocs{}\nwbegincode{437}\moddef{Set \code{}imode\edoc{} for lepton or hadron collisions}\endmoddef
...
\nwendcode{}\nwbegindocs{438}\nwdocspar
\nwenddocs{}\nwbegincode{439}\moddef{Veto: too many or not enough jets after PS}\endmoddef
...
\nwendcode{}\nwbegindocs{440}\nwdocspar
\nwenddocs{}\nwbegincode{441}\moddef{Cluster ME jets with PS jets one at a time}\endmoddef
if (allocated(data%JETS_PS)) then
...
\nwendcode{}\nwbegindocs{442}\nwdocspar
\nwenddocs{}\nwbegincode{443}\moddef{MLM matching: procedures}\plusendmoddef
!C-----------------------------------------------------------------------
!C-----------------------------------------------------------------------
!C-----------------------------------------------------------------------
...
!C-----------------------------------------------------------------------
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{444}\moddef{MLM matching: procedures (not used)}\endmoddef
...
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{445}\moddef{MLM matching: procedures}\plusendmoddef
...
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{446}\moddef{MLM matching: procedures (not used)}\plusendmoddef
...
\nwendcode{}\nwbegincode{447}\moddef{MLM matching: procedures}\plusendmoddef
!C-----------------------------------------------------------------------
...
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{448}\moddef{MLM matching: procedures (not used)}\plusendmoddef
...
\nwendcode{}\nwbegincode{449}\moddef{MLM matching: procedures}\plusendmoddef
!C-----------------------------------------------------------------------
...
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{450}\moddef{MLM matching: procedures (not used)}\plusendmoddef
    SUBROUTINE KTUNIT(R)
      IMPLICIT NONE
...
!C-----------------------------------------------------------------------
\nwendcode{}\nwbegincode{451}\moddef{MLM matching: procedures}\plusendmoddef
    FUNCTION KTMDPI(PHI)
      IMPLICIT NONE
...
\nwenddocs{}\nwbegincode{453}\moddef{\code{}ckkw{\char95}matching.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}CKKW matching: public\RA{}

\LA{}CKKW matching: types\RA{}

contains

\LA{}CKKW matching: procedures\RA{}

end module ckkw_matching
\eatline
\nwendcode{}\nwbegindocs{454}\nwdocspar
\nwenddocs{}\nwbegincode{455}\moddef{CKKW matching: public}\endmoddef
  public :: ckkw_matching_settings_t
\nwendcode{}\nwbegincode{456}\moddef{CKKW matching: types}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{457}\nwdocspar
\nwenddocs{}\nwbegincode{458}\moddef{CKKW matching: public}\plusendmoddef
  public :: ckkw_matching_apply
\nwendcode{}\nwbegindocs{459}\nwdocspar
\nwenddocs{}\nwbegincode{460}\moddef{CKKW matching: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{461}\nwdocspar
\nwenddocs{}\nwbegincode{462}\moddef{CKKW matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{463}\nwdocspar
\nwenddocs{}\nwbegincode{464}\moddef{CKKW matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{465}\nwdocspar
\nwenddocs{}\nwbegincode{466}\moddef{CKKW matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{467}\nwdocspar
\nwenddocs{}\nwbegincode{468}\moddef{CKKW matching: procedures}\plusendmoddef
...
\eatline
\nwendcode{}\nwbegindocs{469}\nwdocspar
\nwenddocs{}\nwbegincode{470}\moddef{CKKW matching: procedures}\plusendmoddef
...
The type {\tt{}ckkw{\char95}pseudo{\char95}shower{\char95}weights{\char95}t} gives the (relative) weights
...
{\tt{}weights{\char95}by{\char95}type} array gives the weights depending on the type of
...
\begin{itemize}
  ...
  \item[4:] gluino
\end{itemize}
{\tt{}alphaS} gives the value for $alpha_s$ used in the generation of the
matrix element. This is needed for the reweighting using the values
for a running $alpha_s$ at the scales of the clusterings.
\nwenddocs{}\nwbegincode{472}\moddef{\code{}ckkw{\char95}pseudo{\char95}weights.f90\edoc{}}\endmoddef
\LA{}File header\RA{}
...
\LA{}CKKW pseudo weights: public\RA{}

\LA{}CKKW pseudo weights: types\RA{}

contains

\LA{}CKKW pseudo weights: procedures\RA{}

end module ckkw_pseudo_weights
\eatline
\nwendcode{}\nwbegindocs{473}\nwdocspar
\nwenddocs{}\nwbegincode{474}\moddef{CKKW pseudo weights: public}\endmoddef
  public :: ckkw_pseudo_shower_weights_t
\nwendcode{}\nwbegincode{475}\moddef{CKKW pseudo weights: types}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{476}\nwdocspar
\nwenddocs{}\nwbegincode{477}\moddef{CKKW pseudo weights: public}\plusendmoddef
  public :: ckkw_pseudo_shower_weights_init
\nwendcode{}\nwbegincode{478}\moddef{CKKW pseudo weights: procedures}\endmoddef
...
\eatline
\nwendcode{}\nwbegindocs{479}\nwdocspar
\nwenddocs{}\nwbegincode{480}\moddef{CKKW pseudo weights: public}\plusendmoddef
  public :: ckkw_pseudo_shower_weights_write
\nwendcode{}\nwbegincode{481}\moddef{CKKW pseudo weights: procedures}\plusendmoddef
...
\nwenddocs{}\nwbegincode{484}\moddef{\code{}shower{\char95}dummy.f90\edoc{}}\endmoddef
module pythia_dummy
  public :: pyinit
  public :: pygive
  public :: pylist
...
contains
  subroutine pylist (i)
    integer, intent(in) :: i
    \LA{}Shower dummy: error message\RA{}
...
\eatline
\nwendcode{}\nwbegindocs{485}\nwdocspar
\nwenddocs{}\nwbegincode{486}\moddef{Shower dummy: error message}\endmoddef
write (0, "(A)")  "**************************************************************"
