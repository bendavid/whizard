...
extern "C" bool hepmc2_available() {
  return true;
}
...
extern "C" GenEvent* h2_new_gen_event( int proc_id, int event_id ) {
...
extern "C" void h2_gen_event_print( GenEvent* evt ) {
  evt->print();
}
...
extern "C" void h2_gen_event_add_vertex( GenEvent* evt, GenVertex* v ) {
  evt->add_vertex( v );
}
...
extern "C" bool h2_gen_event_set_beam_particles
( GenEvent* evt, GenParticle* prt1, GenParticle* prt2) {
  return evt->set_beam_particles( prt1, prt2 );
}

extern "C" void h2_gen_event_set_cross_section
...
extern "C" GenVertex* h2_new_gen_vertex() {
  return new GenVertex();
}

extern "C" GenVertex* h2_new_gen_vertex_pos( FourVector* pos ) {
  return new GenVertex( *pos );
}

extern "C" void h2_gen_vertex_add_particle_in( GenVertex* v, GenParticle* p ) {
  v->add_particle_in( p );
}

extern "C" void h2_gen_vertex_add_particle_out( GenVertex* v, GenParticle* p ) {
  v->add_particle_out( p );
}

extern "C" bool h2_gen_vertex_is_valid( GenVertex* v ) {
  return v != 0;
}

extern "C" int h2_gen_vertex_particles_in_size( GenVertex* v ) {
  return v->particles_in_size();
}

extern "C" int h2_gen_vertex_particles_out_size( GenVertex* v ) {
...
extern "C" GenParticle* h2_new_gen_particle
(FourVector* momentum, int pdg_id, int status) {
  return new GenParticle( *momentum, pdg_id, status );
}

extern "C" void h2_gen_particle_set_flow
( GenParticle* prt, int code_index, int code ) {
  prt->set_flow( code_index, code );
}

extern "C" void h2_gen_particle_set_polarization
( GenParticle* prt, Polarization* pol) {
  prt->set_polarization( *pol );
}

extern "C" int h2_gen_particle_barcode( GenParticle* prt ) {
  return prt->barcode();
}

extern "C" FourVector* h2_gen_particle_momentum( GenParticle* prt ) {
  return new FourVector( prt->momentum() );
}

extern "C" double h2_gen_particle_generated_mass( GenParticle* prt ) {
  return prt->generated_mass();
}

extern "C" int h2_gen_particle_pdg_id( GenParticle* prt ) {
  return prt->pdg_id();
}

extern "C" int h2_gen_particle_status( GenParticle* prt ) {
  return prt->status();
}
...
extern "C" GenVertex* h2_gen_particle_production_vertex( GenParticle* prt ) {
  return prt->production_vertex();
}

extern "C" GenVertex* h2_gen_particle_end_vertex( GenParticle* prt ) {
  return prt->end_vertex();
}

extern "C" Polarization* h2_gen_particle_polarization( GenParticle* prt ) {
  return new Polarization(prt->polarization());
}

extern "C" int h2_gen_particle_flow( GenParticle* prt, int code_index ) {
...
extern "C" FourVector* h2_new_four_vector_xyzt
( double x, double y, double z, double t) {
  return new FourVector( x, y, z, t);
}

extern "C" FourVector* h2_new_four_vector_xyz( double x, double y, double z) {
  return new FourVector( x, y, z);
}

extern "C" void h2_four_vector_delete( FourVector* p ) {
  delete p;
}

extern "C" double h2_four_vector_px( FourVector* p ) {
  return p->px();
}

extern "C" double h2_four_vector_py( FourVector* p ) {
  return p->py();
}

extern "C" double h2_four_vector_pz( FourVector* p ) {
  return p->pz();
}

extern "C" double h2_four_vector_e( FourVector* p ) {
  return p->e();
}
...
extern "C" Polarization* h2_new_polarization( double theta, double phi ) {
  return new Polarization( theta, phi );
}

extern "C" void h2_polarization_delete( Polarization* pol ) {
  delete pol;
}


extern "C" double h2_polarization_theta( Polarization* pol ) {
  return pol->theta();
}

extern "C" double h2_polarization_phi( Polarization* pol ) {
  return pol->phi();
}
...
extern "C" IO_GenEvent* h2_new_io_gen_event_in( char* filename ) {
  return new IO_GenEvent( filename, std::ios::in );
}

extern "C" IO_GenEvent* h2_new_io_gen_event_out( char* filename ) {
  return new IO_GenEvent( filename, std::ios::out );
}

extern "C" void h2_io_gen_event_delete( IO_GenEvent* iostream ) {
  delete iostream;
}
