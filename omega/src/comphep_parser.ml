...
open Parsing;;
let _ = parse_error;;
# 26 "../../../omega/src/comphep_parser.mly"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 48 "../../../omega/src/comphep_parser.mly"
                           ( _1 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 52 "../../../omega/src/comphep_parser.mly"
                           ( S.symbol _1 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 53 "../../../omega/src/comphep_parser.mly"
                           ( S.integer _1 )
# 139 "comphep_parser.ml"
               : 'e))
; (fun __caml_parser_env ->
    Obj.repr(
# 54 "../../../omega/src/comphep_parser.mly"
                           ( S.imag )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 55 "../../../omega/src/comphep_parser.mly"
                           ( S.apply _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 56 "../../../omega/src/comphep_parser.mly"
                           ( _2 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 57 "../../../omega/src/comphep_parser.mly"
                           ( S.dot _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'e) in
    Obj.repr(
# 58 "../../../omega/src/comphep_parser.mly"
                           ( S.multiply _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'e) in
    Obj.repr(
# 59 "../../../omega/src/comphep_parser.mly"
                           ( S.divide _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'e) in
    Obj.repr(
# 60 "../../../omega/src/comphep_parser.mly"
                           ( S.add _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'e) in
    Obj.repr(
# 61 "../../../omega/src/comphep_parser.mly"
                           ( S.subtract _1 _3 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 62 "../../../omega/src/comphep_parser.mly"
                           ( _2 )
...
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'e) in
    Obj.repr(
# 63 "../../../omega/src/comphep_parser.mly"
                           ( S.neg _2 )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 64 "../../../omega/src/comphep_parser.mly"
                           ( S.power _1 _3 )
